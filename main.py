...
from sparsetodense_utils import run_sparsetodense
...
for idx in tqdm(range(len(sample_list))):
    ...
    if config['use_sparsetodense'] is True:
        run_sparsetodense(sample['ref_img_fi'], config['src_folder'], config['depth_folder'])
    ...
    print('*********** Making video spend {}  *************'.format((time.time() - start_video) / 60))

    print('*********** This proces spend {} *************'.format((time.time() - start_time) / 60))
